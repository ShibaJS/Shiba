...
namespace ChakraHosting
{
    ...
    public struct JavaScriptValue
    {
        ...
        {
            if (arguments.Length > ushort.MaxValue) throw new ArgumentOutOfRangeException("arguments");

            Native.ThrowIfError(Native.JsCallFunction(this, arguments, (ushort) arguments.Length,
